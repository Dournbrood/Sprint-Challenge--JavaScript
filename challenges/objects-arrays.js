...
const universities = graduates.map(function (currentValue) {
...
const unisWithUni = graduates.filter(function (currentValue) {
  return currentValue.university.includes("Uni") === true;
});
...
*/
const displayNames = [];
zooAnimals.forEach(function (currentValue, index) {
...
*/
const populationTotal = zooAnimals.reduce(function (accum, currentValue) {
